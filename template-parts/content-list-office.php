    ...
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img1">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/minas1/img1.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/minas1/img2.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/minas1/img3.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/minas1/img4.jpg" alt="">
            </div>
...
<article class="card_office_uni d-flex" data-uf="MG">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img2">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/minas2/img1.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/minas2/img2.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="SP">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img3">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo/img1.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo/img2.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo/img3.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo/img4.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="SP">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img4">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo2/img1.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo2/img2.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo2/img3.jpg" alt="">
                <img class="" src="<?= get_template_directory_uri() ?>/assets/img/offices/saopaulo2/img4.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="SP">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img5">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/ribeirao/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="SP">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img6">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/campinas/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="SP">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img7">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/saocaetano/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="RJ">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img8">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/rio/img1.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/rio/img2.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="ES">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img9">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/es/img1.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/es/img2.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="BA">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img10">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/bahia/img1.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/bahia/img2.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="PE">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img11">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/pe/img1.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/pe/img2.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="PR">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img12">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/parana/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="SC">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img13">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/sc/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="RS">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img14">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/riograndesul/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="DF">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img15">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/df/img1.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/df/img2.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/df/img3.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="GO">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img16">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/goias/img1.jpg" alt="">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/goias/img2.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="MT">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img17">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/matogrosso/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
...
<article class="card_office_uni d-flex" data-uf="MS">
    <div class="f-50 office_uni_img">
        ...
        <div class="slide_imgs" id="slide_img18">
            <div class="content_slide_img">
                <img class="show_img_slide" src="<?= get_template_directory_uri() ?>/assets/img/offices/matogrossosul/img1.jpg" alt="">
            </div>
            <div class="slide_img_nav">
                <button class="btn_prev_slide_img">
                    <span><</span>
